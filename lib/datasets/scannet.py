...
from lib.dataset import SparseVoxelizationDataset, SparseVoxelizationDatasetAL, DatasetPhase, str2datasetphase_type
...
class ScannetSparseVoxelizationDatasetAL(SparseVoxelizationDatasetAL):
